...
namespace Dislicores_Proceso_5_Terceros_a_ClientesPOS.Modulos
{
    public static class ModuloConsumoWSUNOEE
    {
        ...
        public static string cargarConector(string proceso, EstructuraClientesPOS objEnvio)
        {
            ...
            string strMensaje = "";
            string identificador = objEnvio.F9740_ID;
            ...
            do
            {
                ...
                try
                {
                    ...
                    //objSQL.sp_VTEX_Log_Insert("Resultado Consumo Siesa", proceso + " : " + identificador, strMensaje);
                ...
                catch (Exception ex)
                {
                    ...
                    //SQL_DTO.sp_Proceso_4_Log_Guardar(idTercero, idCriterio, true, detalle);
                }
